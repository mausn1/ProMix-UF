        ...
        <div class="container">
            ...
            <hr class="text-light">
                ...
                <div class="row rounded aza">
                    <div class="col-lg mt-5"><img src="/8565.jpg" alt="" class="w-50 justify-content-center mb-3"></div>
                        <div class="col mt-1"><h1 class="fw-bold ">Grönt chai te, 100g</h1>
                            <div class="p-3 text-light "><p><span class="fst-italic lh-lg">En blandning av två klassiker!</span><br>
                            Klassiskt grönt chai te. Anti inflammotorisk med antioxidanter och lugnande. Har smaken av kanel och grönt te. </p>
                        <p class="fw-bold"><i class="bi bi-box-seam"></i> 20 st i lager</p>
                        <p class="fw-bold text-danger fs-1 font-monospace">50 kr</p>
                        <div class="d-inline">
                            <form method="post" action="3">                            <input type="number" step="1" min="1" max="10" value="1" name="quantity3" class=" quantity-field form-control w-50 text-center mx-auto <?php if($errors['quantity3_bad_value']): ?><?php echo 'is-invalid'; ?><?php endif; ?>">
                                              <div id="1" class="invalid-feedback">
                    <?php echo $errors['quantity3_bad_value']; ?>
                  </div>
                            <button type="submit" name="addToCart3" class="mt-3 w-50 btn btn-danger coolbtn ">
                    ...
                    <ul class="nav nav-pills justify-content-center mt-5" id="myTab" role="tablist">
                      ...
                      <div class="tab-content aza p-5" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="include" role="tabpanel" aria-labelledby="include-tab"><span class="fw-bold">Ingredienser:</span> Te, ingefära, kanel, kardemummafrön, peppar, kryddnejlika, kardemummafrukt, arom. </div>
                      </div>
