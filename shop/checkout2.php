        ...
        <div class="min-vh-100 bg-dark text-light">
            <div class="container">
                ...
                <form action="" method="post">
                    <h3 class="lead">VIKTIGT! Skriv ner denna kod när du swishar! <?php echo $_SESSION['coolkey']; ?> </h3>
                    <img src="/swish.jpg" alt="" class="w-50">
                    <p class="lead">Tryck på "Beställ" efter att du har swishat <?php echo $totalcart; ?> kr och vi hör av oss via mejl!</p>
