        ...
        <div class="container">
            ...
            <hr class="text-light">
                ...
                <div class="row rounded aza">
                    <div class="col-lg mt-5"><img src="/8313.jpg" alt="" class="w-50 justify-content-center mb-3"></div>
                        <div class="col mt-1"><h1 class="fw-bold ">Godis Te, 100g</h1>
                            <div class="p-3 text-light "><p><span class="fst-italic lh-lg">Ett riktigt gott te med arom av choklad</span><br>
                            Om du vill ha något gott du kan njuta på under påsklovet och fungerar bra till fika, eller om du bara vill utmana smaksinnet. Med smak av choklad och frukt kommer 
                        det enkelt lämna en varm och god smak på tungan! </p>
                        <p class="fw-bold"><i class="bi bi-box-seam"></i> 20 st i lager</p>
                        <p class="fw-bold text-danger fs-1 font-monospace">50 kr</p>
                        <div class="d-inline">
                            <form method="post" action="1">                            <input type="number" step="1" min="1" max="10" value="1" name="quantity1" class=" quantity-field form-control w-50 text-center mx-auto <?php if($errors['quantity1_bad_value']): ?><?php echo 'is-invalid'; ?><?php endif; ?>">
                                              <div id="1" class="invalid-feedback">
                    <?php echo $errors['quantity1_bad_value']; ?>
                  </div>
                            <button type="submit" name="addToCart1" class="mt-3 w-50 btn btn-danger coolbtn ">
                    ...
                    <ul class="nav nav-pills justify-content-center mt-5" id="myTab" role="tablist">
                      ...
                      <div class="tab-content aza p-5" id="myTabContent">
                        <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab"> <span class="fw-bold">Nettovikt:</span> 100 gram. <br> <span class="fw-bold">Förvaras:</span> Torrt i sin förpackning, ej högre än 25 grader °C. <br><span class="fw-bold">Bruksanvisning:</span> Förbered i kokande vatten. <br>Kontakta <span class="fw-bold text-danger">info@promix-uf.se</span> om du har frågor. </div>
                        <div class="tab-pane fade" id="include" role="tabpanel" aria-labelledby="include-tab"><span class="fw-bold">Ingredienser:</span> Torkade äppelbitar, torkade päronbitar, vitt kakaosmörssplitter (socker, kakaosmör, dextros), torkade ananasbitar (ananas, socker, citronsyra), kakaoskal, kakaobönor, torkade bananbitar (banan, rismjöl), arom, torkade jordgubbsskivor, torkade hallon. <br><span class="fw-bold">Kan innehålla spår av mjölk.</span></div>
                      </div>
