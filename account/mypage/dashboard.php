...
>
        ...
        <div class="min-vh-100 bg-dark max-vw-100">
            <div class="container">
                <div class="row">
                    <div class="col-md">
                        <div class="d-flex flex-column mb-5">
                            <a href="https://promix-uf.se/account/mypage/dashboard" class="text-light text-decoration-none" onselectstart=" false;"><div class="p-2 aja bg-danger rounded">Dashboard</div></a>
                            <a href="https://promix-uf.se/account/mypage/orders" class="text-secondary text-decoration-none" onselectstart=" false;"><div class="p-2 aja rounded">Beställningar</div></a>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <p class="text-light fs-5 fw-bold">Välkommen, <?php echo ($_SESSION['username']); ?>!</p>
                        <p class="text-light">Du är från och med nu medlem hos ProMix UFs officiella hemsida. Vi välkommar dig varmt och hoppas du kan ta del av vårt sortiment.</p>
                        <p class="text-light fw-bold mb-0">Så här fungerar det:</p>   
                        <p class="text-light">Genom att beställa genom webbshoppen gör det enkelt för oss att ta mot beställningar på ett organiserat sätt. Du beställer genom webbshoppen och väljer om du vill betala genom hemsidan och betala frakt för leverans eller om du vill betala direkt och få ditt te på plats. Vi använder oss av Swish. </p>                 
                    </div>
                </div>
            </div>
        </div>
