...
<html lang="en">
  <head>
    ...
    <title>Beställningar - ProMix</title> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md">
                        <div class="d-flex flex-column mb-5">
                            <a href="https://promix-uf.se/account/mypage/dashboard" class="text-secondary text-decoration-none" onselectstart=" false;"><div class="p-2 aja rounded">Dashboard</div></a>
                            <a href="https://promix-uf.se/account/mypage/orders" class="text-light text-decoration-none" onselectstart=" false;"><div class="p-2 aja rounded bg-danger">Beställningar</div></a>
                        </div>
                    </div>
                    <div class="col-md-7">
                ...
                echo "
                  <table class='table table-dark table-bordered table-hover table-sm table-responsive'>
                    ...
                    echo "<p class='lead text-light p-3 bg-danger rounded'><i class='bi bi-info-circle-fill'></i> Du har ej beställt något. <p>";
                }
                        while ($order_row = $orders->fetch_assoc()){
                            ...
                            echo utf8_encode("</td>
                            <td class='table_align_center'>".$column['amount']."</td>
                            <td class='table_align_center'>".$column['price']." kr</td><p class='text-light'>$yo</p>");
                            $totalcart2 += $column['price']*$column['amount'];
