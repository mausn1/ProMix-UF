            ...
            <div class="offcanvas-body d-flex flex-column pt-0">
              ...
              <div class="btn-group dropup mx-auto">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser" data-popper-placement="top-start">
                    ...
                    <li>
                        <a href="https://promix-uf.se/account/mypage/dashboard" class="active dropdown-item">
                            Dashboard
                        </a>
                    </li>
                    <li>
            ...
            <div class="row">
                <div class="col-md">
                        <div class="d-flex flex-column ">
                            ...
                            <a href="https://promix-uf.se/account/mypage/settings/change-password" class="text-light text-decoration-none mb-5" onselectstart=" false;"><div class="p-2 aja rounded bg-danger">Ändra lösenord</div></a>
                        </div>
                </div>
                <div class="col-md-7"> 
                 <?php if($errors['database_error']): ?>
                  <div class="alert alert-danger mt-3" style="border-top-width: 5px;">
                ...
                <?php endif; ?>
                <?php if($message['passchanged']): ?>
                  <div class="alert alert-success mt-3" style="border-top-width: 5px;">
                     <div class="container p-0">
                     <p class="mb-0">
                       <i class="bi bi-check-circle-fill"></i> <?php echo $message['passchanged']; ?>
                      </p>
                     </div>
                  </div>
                <?php endif; ?>
                    <form action="change-password"  method="post">
                        ...
                        <input id="password" name="password" type="password" class="form-control <?php if($errors['password'] or $errors['database_error'] or $errors['passwordsame']): ?><?php echo 'is-invalid'; ?><?php endif; ?> <?php if($message['passchanged']): ?><?php echo 'is-valid'; ?><?php endif; ?>">
                        <label class="text-dark" for="password">Nytt lösenord</label>
                        <div id="1" class="invalid-feedback">
                            <?php echo $errors['password'];  ?>
                        </div>
                        </div>
                        <div class="form-floating">
                        <input id="passwordConf" name="passwordConf" type="password" class="form-control mt-3 <?php if($errors['password'] or $errors['database_error'] or $errors['passwordsame']): ?><?php echo 'is-invalid'; ?><?php endif; ?><?php if($message['passchanged']): ?><?php echo 'is-valid'; ?><?php endif; ?>">
                        ...
                        <div class="d-flex flex-column">
                            <button type="submit" name="settings-changepass-btn" href="" class="btn coolbtn btn-lg btn-danger mt-4">Ändra lösenord</button>
                        </div>
                    </form>
                </div>
              </div>
